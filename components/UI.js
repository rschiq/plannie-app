...
const styles = StyleSheet.create({
  ...
  btnText: { fontFamily: fonts.bodyMedium, fontSize: 16, color: colors.white, letterSpacing: 0.2 },
  outlineBtn: { borderRadius: 999, paddingVertical: 16, alignItems: 'center', borderWidth: 1.5, borderColor: colors.gray3, marginTop: 10 },
  outlineBtnText: { fontFamily: fonts.bodyMedium, fontSize: 15, color: colors.gray },
  ghostBtn: { borderRadius: 999, paddingVertical: 16, alignItems: 'center', backgroundColor: colors.cream2, marginTop: 8 },
  ghostBtnText: { fontFamily: fonts.bodyMedium, fontSize: 15, color: colors.charcoal },
  smallBtn: { borderRadius: 999, paddingHorizontal: 14, paddingVertical: 7 },
  smallBtnText: { fontFamily: fonts.bodyMedium, fontSize: 12 },
